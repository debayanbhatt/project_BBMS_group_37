...
public class DonorController {
	...
	// get donors by id
	@GetMapping("/{id}")
	public Donor getdonorsById(@PathVariable (value = "id") Integer donorId) {
	...
	@PutMapping("/{id}") 
	public String updatecontributor(@RequestBody Donor donor, @PathVariable ("id") Integer donorsId) {
...
//		 existingdonors.setBlood_group(donor.getBlood_group());
	...
	// delete donors by id
	@DeleteMapping("/{id}")
	public ResponseEntity<Donor> deletedonors(@PathVariable ("id") Integer donorsId){
