...
export default function Requests() {
  ...
  // similar to componentDidMount()
    ...
    $(document).ready(function(){
        ...
        $(".detele-modal").click (function(){
            ...
            var modalBodyInput = exampleModal.querySelector('.modal-body input')
             modalTitle.textContent = 'Delete Request  ' + $(this).attr("data-name")
        ...
        $(".edit-modal").click (function(){
            ...
            modalTitle.textContent = 'Edit Requests  ' + $(this).attr("data-id")
            editId.value = $(this).attr("data-id")

            exampleModal.querySelector('.modal-body input[name=approved_date]').value = $(this).attr("data-approved_date")
    ...
    function deleteModalForm(e)
    {
        ...
        .then(res => {
            console.log(res)
            document.getElementById("deleted").innerHTML ="Request deleted";
            setTimeout(function(){
                document.querySelector("#deleteEmployeeModal .close").click();
                document.getElementById("deleted").innerHTML ="";
                ourReadyTable()
    ...
    function updateModalForm(e)
    {
        ...
        .then((res) => {
            console.log(res)
            document.getElementById("updated").innerHTML ="Request updated";
            setTimeout(function(){
                                ...
                                <table className="table table-striped table-hover">
                                    ...
                                    {items.map(item => (
                                        <tr key={item.id}>
                                            ...
                                            <td>{item.units}</td>
                                            <td>
                                                <a href="#editEmployeeModal"  className="edit edit-modal" data-toggle="modal" data-id={item.id} data-approved_date={item.approved_date}  ><i className="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                ...
                                <form id="addModalForm" onSubmit={addModalForm}>
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" name="blood_group" required />
                                        </div>
                                        <div className="form-group">
                                            <label>Address</label>
                                ...
                                <form id="updateModalForm" onSubmit={updateModalForm}>
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="date" className="form-control" name="approved_date" required />
                                        </div>
                                        <div className="form-group">
                                            <label>Status</label>
